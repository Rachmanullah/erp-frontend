            ...
            {isModalDetail && (
                <div className="fixed inset-0 flex items-center justify-center z-50">
                    ...
                    >
                        ...
                        <div className="mb-4">
                            <Image
                                src={`http://192.168.224.160:2000/${selectedProduct.gambar_produk}`}
                    ...
                    dataProduct.map((item, index) => (
                        <div key={index} onClick={() => handleCardClick(item)} className="bg-white p-4 rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105 cursor-pointer">
                            <div className="h-40 bg-gray-200 rounded-lg">
                                <Image src={`http://192.168.224.160:2000/${item.gambar_produk}`} alt={item.nama_produk} width={300} height={300} className="w-full h-full object-cover rounded-lg" />
                            </div>
